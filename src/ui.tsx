...
const hooksWindow: any = window
hooksWindow.preactHooks = preactHooks

const { useEffect, useMemo, useState } = hooksWindow.preactHooks as any
...
function Plugin() {
  ...
  function handleExampleChange(event: any) {
    const exampleName = event.currentTarget.value
